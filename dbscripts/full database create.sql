...
create table tblNutritionalInformation (
    ...
    measurement_id INT NOT NULL,
     CONSTRAINT fk_ni_measure FOREIGN KEY(measurement_id) REFERENCES tblMeasurement(measurement_id)
    )
    ENGINE=InnoDB DEFAULT CHARSET=utf8; 
...
create table tblRecipeIngredient (
	recipe_ingredient_id INT NOT NULL PRIMARY KEY, 
...
create table tblIngredientNutritionanInformation (
	rni_id INT NOT NULL PRIMARY KEY,
    ingredient_id INT NOT NULL,
    ni_id INT NOT NULL,
    amount INT,
    measurement_id int NOT NULL,
...
create table tblRecipeMeals (
    recipe_meal_id INT NOT NULL PRIMARY KEY,
    recipe_id INT NOT NULL, 
